...
Application mobile Flutter pour scanner une carte TCG Pokémon, l'identifier via une API de vision par ordinateur, puis ouvrir automatiquement la page Cardmarket correspondante (marché FR).

## Petite Demo de l'API

- API Health check: https://projetcardmarket-production.up.railway.app/health
...
- Filtrage langue FR (`language=2`) pour les prix Cardmarket (/!\ ne fonctionne pas pour le moment) /!\
